...
export default function HostHistoryError({ reset }: { reset: () => void }) {
  return (
    <main className="min-h-screen bg-canvas px-6 py-12">
      <div className="mx-auto max-w-xl rounded-[12px] border border-line bg-surface p-8 shadow-soft">
        <h1 className="text-xl font-semibold tracking-tight text-ink">Не удалось загрузить проведённые игры</h1>
